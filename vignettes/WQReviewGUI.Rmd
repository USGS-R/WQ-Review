...
These tabs will be present when the "Generate batch files" button is pressed in Chrome. See "Reviewed unapproved data" above. The tabs can copied and saved into text files for modifying DQI codes and comments with QWDATA.
