...
1. **End date**: The end date for the data import. Samples collected before this date will be retrieved. The default is the current date.

1. **Server name (DSN)**: The name of your NWIS server data source name (DSN) that was established during ODBC setup.

1. **Environmental DB number**: The number coresponding to the environmental database. Default is "01"

1. **QA DB Number**: The number coresponding to the QA sample database. Default is "02"
